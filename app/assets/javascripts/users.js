...
// 	    label: {'position': 'top'},
// 	    domainGutter: 10,
// 	    start: new Date(gon.us_start_date),
// 	    highlight: ["now"],
// 	    previousSelector: '#us-hm-previous',
// 	    nextSelector: '#us-hm-next',
// 	    data: JSON.parse(gon.us_heatmap) || null
// 	});
...
// 	var W = $("#us-trulia-testes").parent().width(), // bootsrap col-xs-12
